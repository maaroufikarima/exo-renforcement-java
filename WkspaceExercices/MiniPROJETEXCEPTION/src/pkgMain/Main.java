...
public class Main {
	...
	public static void main(String[] args)throws Exception {
		...
		// ----------------------------------------------------
		// Création de variables temporaires réutilisables
		...
		try {
			...
			System.out.println("solde du compte courant de karima après retrait:"+t_refCompte_titulaire1_courant.get_Integer_solde());
			...
			// Choix 1 : avec une methode statique à la classe Compte
			...
			System.out.println("solde du compte courant de karima après viremnt:"+t_refCompte_titulaire1_courant.get_Integer_solde());
			
			//afficher le solde du compte courant de jack apres virement 
			System.out.println("solde du compte courant de jack après viremnt:"+t_refCompte_titulaire2_courant.get_Integer_solde());
			
			// Choix 2 : avec une methode interne à la classe compte
